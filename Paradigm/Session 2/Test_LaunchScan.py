...
# -*- coding: utf-8 -*-
"""
Created on Wed May  1 16:38:31 2019

@author: Lulu test pulse

https://github.com/psychopy/psychopy/blob/master/psychopy/demos/coder/experiment%20control/fMRI_launchScan.py#L71
...
logFile=logging.LogFile('test_Launchscan.log', level=logging.EXP)
# settings for launchScan:
MR_settings = {
    'TR': 2.000,     # duration (sec) per whole-brain volume
    'volumes': 170,    # number of whole-brain 3D volumes per scanning run
